      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-xs sm:text-sm text-slate-500 mt-1">
            Review your profile preview exactly as schools will see it before publishing.
          </p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="border-b border-slate-100 pb-4 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    This profile will appear in school search results across Karachi.
                  </p>
                </div>
              ...
              <div className="max-w-xl mx-auto bg-white rounded-3xl border-2 border-blue-500/40 p-6 sm:p-8 shadow-xl space-y-5 relative overflow-hidden">
                ...
                <div className="bg-slate-50/90 rounded-2xl p-4 sm:p-5 border border-slate-200/80 space-y-3 text-xs sm:text-sm">
                  ...
                  <div className="flex items-center justify-between gap-3 pt-3 border-t border-slate-200/80">
                    ...
                    <span className="font-black text-blue-700 text-base sm:text-lg text-right">{formattedSalary}</span>
                  </div>
                </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200/80 space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                  ...
                  <div className="flex items-center justify-between bg-white p-2.5 rounded-xl border border-slate-200">
                    <span className="text-slate-600 truncate"><strong>Subjects:</strong> {draft.subjects?.join(', ')}</span>
                    <Button variant="ghost" size="sm" href="/create-card/step-3" className="h-6 px-2 text-[11px]">
                      Edit
                    </Button>
                  </div>
                  <div className="flex items-center justify-between bg-white p-2.5 rounded-xl border border-slate-200">
                    <span className="text-slate-600 truncate"><strong>Location:</strong> {draft.area}, {draft.city}</span>
