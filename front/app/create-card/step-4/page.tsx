            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="border-b border-slate-100 pb-4">
                <h3 className="text-lg font-bold text-slate-900">
                  Location &amp; Availability Shift
                </h3>
                <p className="text-xs text-slate-500 mt-0.5">
                  TeachConnect V1 is exclusively dedicated to <strong>District Malir, Karachi</strong>.
                </p>
              </div>
              ...
              {/* Malir Location Section (District -> Town -> UC) */}
              <div className="pt-2 border-t border-slate-100 space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5 text-slate-900 font-bold text-sm">
                    <MapPin className="w-4 h-4 text-blue-600" />
                    <span>District Malir Location Hierarchy</span>
                  </div>
                ...
                <div className="flex items-center gap-1.5 text-[11px] text-slate-500 pt-1">
                  ...
                  <span>Privacy rule: Only your Town &amp; UC are shown to schools. Your exact home address is never collected.</span>
                </div>
              </div>
